...
<!-- |    Description: Xacro file for 1R Manipulator                                   | -->
<!-- |    for URDF: rosrun xacro xacro model.xacro > model.urdf                        | -->
<!-- =================================================================================== -->

This is to use XACRO for scaling down models and then to produce URDF files for ROS RVIZ or SDF files from URDF for Gazebosim
